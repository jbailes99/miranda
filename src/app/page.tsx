  ...
  return (
    ...
    >
      <div className='grid grid-cols-1 md:grid-cols-2 '>
        {/* Text Section */}
        <div className='sm:flex sm:flex-col justify-center text-left sm:mb-32 mb-2 '>
          <div className='sm:mb-0 mb-4 '>
            <h1 className='text-gray-800 font-bold text-center sm:text-massive '>MIRANDA</h1>
            <h1 className='text-gray-400 text-center sm:tracking-[2em] tracking-[.5em]'>FILM MAKER</h1>

            <h1 className='text-gray-800 font-bold text-center sm:text-massive '>GRAVES</h1>
          </div>
          <h2></h2>
          <h1 className='text-center text-2xl sm:block hidden text-gray-400'>
            <Link href='/director'>
        ...
        {/* Image Section */}
        <div className='flex flex-col text-center items-center justify-center sm:mb-32 mb-4'>
